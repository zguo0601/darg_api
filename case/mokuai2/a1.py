...
def test():
    ...
    #
    # #  通过id获取元素:最准确
    app = driver.find_element_by_id("tv.danmaku.bili:id/tab_title")
    # app.click()
    #
    # # 返回键
    # driver.back()
